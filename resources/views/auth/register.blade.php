<x-seller-auth-layout>
    ...
    <form method="POST" action="{{ route('seller.register') }}" class="space-y-5">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="block text-sm font-medium text-purple-900">
                Nama Lengkap
            </label>
            <div class="mt-1">
        ...
        <!-- Confirm Password -->
        <div x-data="{ show: false }">
            <label for="password_confirmation" class="block text-sm font-medium text-purple-900">
                Konfirmasi Password
            </label>
            <div class="mt-1 relative">
        ...
        <div class="mt-6 text-center text-sm">
            <span class="text-purple-600">Sudah punya akun?</span>
            <a href="{{ route('seller.login') }}" class="font-bold text-purple-800 hover:text-purple-900 ml-1">
                Masuk di sini
            </a>
        </div>
    </form>
